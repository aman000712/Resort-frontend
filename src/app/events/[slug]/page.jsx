    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-200 to-red-300 py-30 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
           ...
           <div className="lg:w-1/2 relative">
                ...
                event.category === "Current" ? "bg-red-600" :
                event.category === "Upcoming" ? "bg-red-600" :
                "bg-red-600"
              }`}>
                {event.category}
              </span>
        ...
        <div className="flex justify-between items-center mt-8">
          <Link
            href="/events"
            className="inline-flex items-center gap-2 text-gray-600 font-semibold text-xl hover:text-gray-900 transition-colors underline-offset-4 underline"
          >
             All Events
          </Link>
