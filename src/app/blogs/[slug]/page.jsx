...
const blogData = {
  "marriage-blog": {
    ...
    date: "Sept 6, 2019",
    author: "Admin",
    content: `Full blog content about discovering beautiful resorts in Asia...Asia is home to some of the world's most mesmerizing resorts surrounded by lush forests, pristine beaches, and breathtaking landscapes.
  ...
  "birthday-blog": {
    ...
    date: "Sept 6, 2019",
    author: "Admin",
    content: `Full blog content about luxury resort experiences...Luxury resorts are designed to offer the ultimate escape with serene views, world-class spas, fine dining, and personalized experiences.
              Whether it's a birthday celebration or a romantic getaway, these resorts offer unmatched comfort and elegance.Enjoy infinity pools, private beaches, scenic mountain views, and exclusive wellness programs crafted for complete relaxation.
    `,
    description:
  ...
  "meeting-blog": {
    ...
    date: "Sept 6, 2019",
    author: "Admin",
    content: `Full blog content about charming seaside resorts...Seaside resorts offer the perfect escape for travelers seeking peace, scenic beauty, and refreshing coastal winds.
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 relative">
              ...
              <span className={`absolute top-4 right-4 text-white text-sm font-semibold px-3 py-1 rounded-full ${blog.category === "Current" ? "bg-green-600" :
                  blog.category === "Upcoming" ? "bg-blue-600" :
                    "bg-gray-600"
                }`}>
                {blog.category}
              </span>
